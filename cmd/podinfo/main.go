...
func main() {
	...
	fs.String("ui-message", fmt.Sprintf("My nice greetings from podinfo v%v", version.VERSION), "UI message")
	...
	viper.SetDefault("ui-logo", "https://raw.githubusercontent.com/jukatu/podinfo/master/pic/ui-pic.gif")
